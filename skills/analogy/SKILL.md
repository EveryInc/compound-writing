---
name: analogy
description: Generate analogy options to explain a concept. Invoke with /analogy or /analogy [concept to explain].
---
...
- `/analogy [concept]` — Generate analogies for the specified concept
- `/analogy` — System asks "What concept do you want to explain?" then generates options
