---
name: hook
description: Generate 3 hook options tailored to your content. Invoke with /hook or /hook [topic/context].
---
...
- `/hook [context]` — Generate hooks for the specified topic/piece
- `/hook` — System asks "What's the piece about?" then generates options
