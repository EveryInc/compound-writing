---
name: simplify
description: Rewrite complex text in plainer language. Invoke with /simplify or /simplify [paste text].
---
...
- `/simplify [text]` — Simplify the provided text
- `/simplify` — System asks "What section do you want me to simplify?"
