#!/usr/bin/env python3
"""Create the canonical Compound Writing project structure without overwriting files."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Create VOICE.md, STYLE.md, examples/, and drafts/ for one writing project."
    )
    parser.add_argument("target", type=Path, help="Project folder to create or initialize")
    parser.add_argument(
        "--add-missing",
        action="store_true",
