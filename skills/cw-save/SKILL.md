...
Report the exact rule captured and the file or system updated. If a higher-authority destination requires approval, provide the proposed wording and wait instead of pretending it was saved.
